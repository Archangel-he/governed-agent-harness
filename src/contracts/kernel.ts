...
export interface KernelDependencies { maxSteps?:number;maxRetries?:number;retryDelayMs?:number;requestErrorHandlers?:import("./loop.js").RequestErrorHandler[]; model: ModelProvider; tools: Record<string, ToolProvider>; emit?(event: KernelEvent): void | Promise<void>; }
